...
const Driving = () => {
  ...
  const products = [
    { id: "prod-1", name: "Leather Driving Gloves", price: 34.99, rating: 5, category: "Apparel", desc: "Premium full-grain leather driving gloves with knuckle ventilation for precise steering grip.", image: "https://images.unsplash.com/photo-1583121274602-3e2820c69888?auto=format&fit=crop&w=600&q=80", icon: "gloves" },
    { id: "prod-2", name: "Performance Shift Knob", price: 59.99, rating: 5, category: "Equipment", desc: "Weighted billet aluminum shift knob for faster, smoother gear changes.", image: "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?auto=format&fit=crop&w=600&q=80", icon: "dumbbell" },
    { id: "prod-3", name: "Radar Detector Pro", price: 299.99, rating: 4, category: "Electronics", desc: "Long-range radar and laser detector with GPS lockouts and real-time alerts.", image: "https://images.unsplash.com/photo-1503376710349-2509121c2105?auto=format&fit=crop&w=600&q=80", icon: "monitor" },
    { id: "prod-4", name: "Carbon Fiber Steering Wheel Cover", price: 49.99, rating: 5, category: "Accessories", desc: "Genuine carbon fiber weave with microfiber leather side grips.", image: "https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&w=600&q=80", icon: "rope" },
    { id: "prod-5", name: "Magnetic Phone Mount", price: 14.99, rating: 4, category: "Accessories", desc: "Ultra-strong neodymium magnetic vent mount for hands-free navigation.", image: "https://images.unsplash.com/photo-1494976388531-d1058494cdd8?auto=format&fit=crop&w=600&q=80", icon: "bottle" },
    { id: "prod-6", name: "Racing Pedal Set", price: 39.99, rating: 5, category: "Equipment", desc: "Anti-slip aluminum pedals designed for optimal heel-toe downshifting.", image: "https://images.unsplash.com/photo-1511919884226-fd3cad34687c?auto=format&fit=crop&w=600&q=80", icon: "belt" },
    { id: "prod-7", name: "Portable Tire Inflator", price: 28.99, rating: 4, category: "Accessories", desc: "12V digital air compressor with auto-shutoff and emergency LED light.", image: "https://images.unsplash.com/photo-1553440569-bcc63803a83d?auto=format&fit=crop&w=600&q=80", icon: "chalk" },
    { id: "prod-8", name: "Nomex Racing Shoes", price: 119.99, rating: 4, category: "Apparel", desc: "FIA-approved fire-resistant racing shoes with ultra-thin pedal feel sole.", image: "https://images.unsplash.com/photo-1542281286-9e0a16bb7366?auto=format&fit=crop&w=600&q=80", icon: "shirt" }
  ];

  const advisors = [
    { id: "adv-1", name: "Lewis Hamilton", specialty: "F1 Racing & Performance Driving", rating: 4.99, reviews: 9410, status: "Online", bio: "7x Formula 1 World Champion. Consult on high-speed cornering, mental preparation, G-force management and elite track technique.", color: "linear-gradient(135deg, #a18cd1, #fbc2eb)", image: "https://ui-avatars.com/api/?name=Lewis+Hamilton&background=a18cd1&color=fff&size=200" },
    { id: "adv-2", name: "Max Verstappen", specialty: "Aggressive Overtaking", rating: 4.96, reviews: 5980, status: "Online", bio: "F1 World Champion. Learn the art of late braking, aggressive race starts, and wet-weather control.", color: "linear-gradient(135deg, #ff9a9e, #fecfef)", image: "https://ui-avatars.com/api/?name=Max+Verstappen&background=ff9a9e&color=fff&size=200" },
    { id: "adv-3", name: "Ken Block (Legacy)", specialty: "Gymkhana & Precision Drifting", rating: 4.98, reviews: 11840, status: "Offline", bio: "Master of Gymkhana. Legendary techniques in handbrake turns, all-wheel-drive sliding, and extreme car control.", color: "linear-gradient(135deg, #f6d365, #fda085)", image: "https://ui-avatars.com/api/?name=Ken+Block&background=f6d365&color=fff&size=200" },
    { id: "adv-4", name: "Sabine Schmitz (Legacy)", specialty: "Nürburgring Mastery", rating: 4.99, reviews: 12150, status: "Offline", bio: "The Queen of the Nürburgring. Unmatched knowledge of racing lines, elevation changes, and blind corner anticipation.", color: "linear-gradient(135deg, #84fab0, #8fd3f4)", image: "https://ui-avatars.com/api/?name=Sabine+Schmitz&background=84fab0&color=000&size=200" },
    { id: "adv-5", name: "Jenson Button", specialty: "Smooth Driving & Race Strategy", rating: 4.91, reviews: 2420, status: "Busy", bio: "F1 World Champion known for rain mastery and smooth driving style. Consult on fuel conservation, tyre management and strategic overtaking.", color: "linear-gradient(135deg, #a1c4fd, #c2e9fb)", image: "https://ui-avatars.com/api/?name=Jenson+Button&background=a1c4fd&color=000&size=200" },
    { id: "adv-6", name: "Ben Collins", specialty: "Stunt Driving & Evasion", rating: 4.93, reviews: 6830, status: "Online", bio: "Formerly 'The Stig'. Expert in precision stunt driving, J-turns, PIT maneuvers, and high-speed evasion techniques.", color: "linear-gradient(135deg, #cfd9df, #e2ebf0)", image: "https://ui-avatars.com/api/?name=Ben+Collins&background=cfd9df&color=000&size=200" },
    { id: "adv-7", name: "Michèle Mouton", specialty: "Defensive Driving & Safety", rating: 4.94, reviews: 2180, status: "Online", bio: "Rally legend and FIA safety ambassador. Expert in defensive driving, hazard anticipation, emergency braking and road risk assessment.", color: "linear-gradient(135deg, #fdcbf1, #e6dee9)", image: "https://ui-avatars.com/api/?name=Michele+Mouton&background=fdcbf1&color=000&size=200" },
    { id: "adv-8", name: "Gordon Murray", specialty: "Vehicle Dynamics & Engineering", rating: 4.92, reviews: 1180, status: "Busy", bio: "Legendary automotive designer. Learn how vehicle weight, aerodynamics, and suspension geometry affect your driving feel.", color: "linear-gradient(135deg, #fdcbf1, #e6dee9)", image: "https://ui-avatars.com/api/?name=Gordon+Murray&background=fdcbf1&color=000&size=200" },
    { id: "adv-9", name: "Tanner Foust", specialty: "Drifting & Stunt Driving", rating: 4.95, reviews: 2840, status: "Online", bio: "Global Rallycross and drifting champion. Expert in controlled drift techniques, weight transfer physics, and showstopping stunt car maneuvering.", color: "linear-gradient(135deg, #cfd9df, #e2ebf0)", image: "https://ui-avatars.com/api/?name=Tanner+Foust&background=cfd9df&color=000&size=200" },
    { id: "adv-10", name: "Stig Blomqvist", specialty: "Rally & Low Traction Control", rating: 4.88, reviews: 1390, status: "Online", bio: "World Rally Champion. Learn left-foot braking, Scandinavian flicks, and maintaining momentum on snow and gravel.", color: "linear-gradient(135deg, #fbc2eb, #a6c1ee)", image: "https://ui-avatars.com/api/?name=Stig+Blomqvist&background=fbc2eb&color=000&size=200" }
  ];

  const certifications = [
    { id: "cert-1", name: "Certified Defensive Driver (CDD)", body: "Mastery Safety Institute", price: 99.99, modules: 5, difficulty: "Intermediate", desc: "Master hazard perception, emergency braking protocols, and collision avoidance techniques for everyday driving.", icon: "cpt", image: "https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?auto=format&fit=crop&w=600&q=80" },
    { id: "cert-2", name: "High Performance Track Driving", body: "Elite Racing Academy", price: 399.99, modules: 6, difficulty: "Advanced", desc: "Engineered for track enthusiasts. Highlights apex hunting, trail braking, weight transfer, and telemetry analysis.", icon: "cscs", image: "https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?auto=format&fit=crop&w=600&q=80" },
    { id: "cert-3", name: "Eco-Driving Specialist (EDS)", body: "Mastery Green Division", price: 149.99, modules: 4, difficulty: "Beginner-Intermediate", desc: "Learn hypermiling techniques, predictive acceleration, and momentum conservation to maximize fuel economy and EV range.", icon: "cfn", image: "https://images.unsplash.com/photo-1593941707882-a5bba14938c7?auto=format&fit=crop&w=600&q=80" },
    { id: "cert-4", name: "Professional Chauffeur Certification", body: "Mastery VIP Transport", price: 249.99, modules: 5, difficulty: "Advanced", desc: "Learn to provide the smoothest VIP ride possible. Focuses on seamless braking, route planning, and executive security driving.", icon: "ces", image: "https://images.unsplash.com/photo-1610647752706-3bb12232b3ab?auto=format&fit=crop&w=600&q=80" }
  ];
    ...
    <div className="fitness-container page-enter">
      ...
      {showBackConfirm && (
        <div className="fitness-modal-overlay" style={{ zIndex: 2000 }}>
          <div className="fitness-modal-container" style={{ width: "420px", textAlign: "center", padding: "40px", borderColor: "#8a2be2" }}>
            <h2 className="fitness-modal-title" style={{ fontSize: "28px", color: "#8a2be2" }}>LEAVE ZONE?</h2>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", gap: "20px" }}>
              ...
              <button 
                ...
                style={{ flex: 1, padding: "14px", background: "#8a2be2", color: "white", border: "2px solid #8a2be2", borderRadius: "30px", fontWeight: "bold", cursor: "pointer", boxShadow: "0 4px 15px rgba(138, 43, 226, 0.4)", transition: "all 0.2s" }}
