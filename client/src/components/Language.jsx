...
const Language = () => {
  ...
  const products = [
    { id: "prod-1", name: "Comprehensive Spanish Textbook", price: 49.99, rating: 5, category: "Books", desc: "Master Spanish grammar, vocabulary, and culture with this detailed guide.", image: "https://images.unsplash.com/photo-1544716278-ca5e3f4cb8c0?auto=format&fit=crop&w=600&q=80", icon: "book" },
    { id: "prod-2", name: "Premium Headset with Mic", price: 89.99, rating: 5, category: "Hardware", desc: "Crystal clear audio for speaking practice and listening comprehension.", image: "https://images.unsplash.com/photo-1599669454699-248893623440?auto=format&fit=crop&w=600&q=80", icon: "headphones" },
    { id: "prod-3", name: "Bilingual Dictionary (English-Hindi)", price: 29.99, rating: 4, category: "Books", desc: "Over 100,000 words and phrases. Essential for intermediate learners.", image: "https://images.unsplash.com/photo-1589829085413-56de8ae18c73?auto=format&fit=crop&w=600&q=80", icon: "dictionary" },
    { id: "prod-4", name: "Pocket Electronic Translator", price: 129.99, rating: 5, category: "Hardware", desc: "Real-time voice translation across 40 different languages offline.", image: "https://images.unsplash.com/photo-1601931885625-bd61314d3df1?auto=format&fit=crop&w=600&q=80", icon: "device" },
    { id: "prod-5", name: "Flashcards Set: Essential Kanji", price: 19.99, rating: 4, category: "Accessories", desc: "500 most common Kanji characters for quick memorization.", image: "https://images.unsplash.com/photo-1584697964190-7cb5295c52c6?auto=format&fit=crop&w=600&q=80", icon: "cards" },
    { id: "prod-6", name: "Language Learning Software (1 Yr)", price: 119.99, rating: 5, category: "Software", desc: "Full access to our interactive software platform. Track your fluency.", image: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=600&q=80", icon: "laptop" },
    { id: "prod-7", name: "Notebook & Polyglot Pen Set", price: 14.99, rating: 4, category: "Accessories", desc: "Jot down new vocabulary and grammar rules in style.", image: "https://images.unsplash.com/photo-1516382799247-87df95d790b7?auto=format&fit=crop&w=600&q=80", icon: "notebook" },
    { id: "prod-8", name: "Polyglot T-Shirt", price: 24.99, rating: 4, category: "Apparel", desc: "'Hello' written in 20 languages. Wear your passion for languages.", image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=600&q=80", icon: "shirt" }
  ];

  const advisors = [
    { id: "adv-1", name: "Elena Rossi", specialty: "Romance Languages & Accent Reduction", rating: 4.99, reviews: 3410, status: "Online", bio: "Fluent in Italian, Spanish, and French. Specializes in conversational fluency and reducing thick accents for beginners.", color: "linear-gradient(135deg, #a18cd1, #fbc2eb)", image: "https://ui-avatars.com/api/?name=Elena+Rossi&background=a18cd1&color=fff&size=200" },
    { id: "adv-2", name: "Kenji Sato", specialty: "Japanese Kanji & Business Etiquette", rating: 4.96, reviews: 2980, status: "Online", bio: "Tokyo native. Master of JLPT prep, Kanji memorization hacks, and formal business communication (Keigo).", color: "linear-gradient(135deg, #ff9a9e, #fecfef)", image: "https://ui-avatars.com/api/?name=Kenji+Sato&background=ff9a9e&color=fff&size=200" },
    { id: "adv-3", name: "Dr. Ananya Sharma", specialty: "Dravidian & Indo-Aryan Roots", rating: 4.93, reviews: 1840, status: "Online", bio: "Linguistics professor. Expert in Kannada, Tamil, and Hindi grammar structures and cultural immersion.", color: "linear-gradient(135deg, #f6d365, #fda085)", image: "https://ui-avatars.com/api/?name=Ananya+Sharma&background=f6d365&color=fff&size=200" },
    { id: "adv-4", name: "Marcus Schmidt", specialty: "Germanic Languages & Syntax", rating: 4.89, reviews: 2150, status: "In Session", bio: "German native speaker. Makes complex grammar, compound words, and strict syntax rules easy to digest.", color: "linear-gradient(135deg, #84fab0, #8fd3f4)", image: "https://ui-avatars.com/api/?name=Marcus+Schmidt&background=84fab0&color=000&size=200" },
    { id: "adv-5", name: "Li Wei", specialty: "Mandarin Tones & Calligraphy", rating: 4.97, reviews: 1420, status: "Busy", bio: "Beijing-based instructor focusing on the 4 tones of Mandarin, pinyin mastery, and cultural nuances.", color: "linear-gradient(135deg, #a1c4fd, #c2e9fb)", image: "https://ui-avatars.com/api/?name=Li+Wei&background=a1c4fd&color=000&size=200" },
    { id: "adv-6", name: "Sofia Martinez", specialty: "Spanish Conjugation & Slang", rating: 4.99, reviews: 6830, status: "Offline", bio: "Latin American Spanish expert. Learn practical conversational Spanish, regional slang, and rapid verb conjugations.", color: "linear-gradient(135deg, #cfd9df, #e2ebf0)", image: "https://ui-avatars.com/api/?name=Sofia+Martinez&background=cfd9df&color=000&size=200" },
    { id: "adv-7", name: "David Kim", specialty: "Korean Hangul & K-Pop Culture", rating: 4.95, reviews: 840, status: "Online", bio: "Seoul native. Teaches Hangul reading in one hour, followed by immersive learning through Korean media.", color: "linear-gradient(135deg, #fbc2eb, #a6c1ee)", image: "https://ui-avatars.com/api/?name=David+Kim&background=fbc2eb&color=000&size=200" },
    { id: "adv-8", name: "Fatima Al-Sayed", specialty: "Arabic Script & MSA", rating: 4.92, reviews: 1180, status: "Online", bio: "Modern Standard Arabic (MSA) specialist. Detailed guidance on right-to-left script writing and pronunciation.", color: "linear-gradient(135deg, #fdcbf1, #e6dee9)", image: "https://ui-avatars.com/api/?name=Fatima+Al+Sayed&background=fdcbf1&color=000&size=200" },
    { id: "adv-9", name: "Ivan Volkov", specialty: "Russian Cases & Cyrillic", rating: 4.87, reviews: 1540, status: "In Session", bio: "Russian linguist. Demystifies the 6 Russian cases, Cyrillic alphabet reading, and rolling your R's.", color: "linear-gradient(135deg, #a18cd1, #fbc2eb)", image: "https://ui-avatars.com/api/?name=Ivan+Volkov&background=a18cd1&color=fff&size=200" },
    { id: "adv-10", name: "Chloe Dupont", specialty: "French Pronunciation & Literature", rating: 4.88, reviews: 1390, status: "Online", bio: "Parisian tutor. Focuses on silent letters, nasal sounds, and reading classic French literature for vocabulary.", color: "linear-gradient(135deg, #fbc2eb, #a6c1ee)", image: "https://ui-avatars.com/api/?name=Chloe+Dupont&background=fbc2eb&color=000&size=200" }
  ];

  const certifications = [
    { id: "cert-1", name: "Beginner Fluency (A1-A2)", body: "Mastery Language Academy", price: 199.99, modules: 5, difficulty: "Beginner", desc: "Gain essential knowledge for basic greetings, everyday survival phrases, and simple sentence construction.", icon: "cpt", image: "https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?auto=format&fit=crop&w=600&q=80" },
    { id: "cert-2", name: "Intermediate Conversationalist (B1-B2)", body: "Global Linguistics Board", price: 299.99, modules: 6, difficulty: "Intermediate", desc: "Hold extended conversations. Highlights expressing opinions, past/future tenses, and consuming foreign media.", icon: "cscs", image: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=600&q=80" },
    ...
    { id: "cert-4", name: "Advanced Native Fluency (C1-C2)", body: "International Mastery Institute", price: 249.99, modules: 5, difficulty: "Advanced", desc: "Achieve near-native proficiency. Focus on idioms, complex grammar structures, and academic writing.", icon: "ces", image: "https://images.unsplash.com/photo-1516321497487-e288fb19713f?auto=format&fit=crop&w=600&q=80" }
  ];
