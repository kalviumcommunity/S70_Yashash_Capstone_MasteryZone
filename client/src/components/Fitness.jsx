...
const Fitness = () => {
  ...
  const [activeCategory, setActiveCategory] = useState("BICEPS");
  ...
  // Static Data
  const exercises = ["BICEPS", "CHEST", "LEGS", "TRICEPS", "BACK", "WARM UP", "SHOULDER"];

  const websiteMap = {
    BICEPS: "https://www.muscleandstrength.com/exercises/biceps",
    CHEST: "https://www.muscleandstrength.com/exercises/chest",
    LEGS: "https://www.muscleandstrength.com/exercises/quads",
    TRICEPS: "https://www.muscleandstrength.com/exercises/triceps",
    BACK: "https://www.bodybuilding.com/exercises/muscle/middle-back", // Re-mapped middle-back directory
    "WARM UP": "https://www.healthline.com/health/fitness-exercise/warm-up-exercises",
    SHOULDER: "https://www.muscleandstrength.com/exercises/shoulders"
  };
  ...
  const youtubeVideoMap = {
    ...
    BACK: "EVDZk9H2V1s",
    "WARM UP": "E52qO67S1s0",
    SHOULDER: "2-n0BvPrK-I"
  };

  // E-Commerce Premium Products Database with real-life generated photos
  const products = [
    { id: "prod-1", name: "Neon Hex Dumbbells (Pair)", price: 79.99, rating: 5, category: "Equipment", desc: "Rubber-coated heavy grip dumbbells styled with active purple accent rings.", image: "https://loremflickr.com/600/600/dumbbell,gym?lock=11", icon: "dumbbell" },
    { id: "prod-2", name: "Premium Whey Isolate", price: 59.99, rating: 5, category: "Supplements", desc: "Pure micro-filtered chocolate fudge isolate. 25g protein, 0g sugar.", image: "https://loremflickr.com/600/600/protein,powder?lock=12", icon: "protein" },
    { id: "prod-3", name: "Ultra-Stretch Gym Tee", price: 29.99, rating: 4, category: "Apparel", desc: "Engineered moisture-wicking fit that moves with you during high-intensity sessions.", image: "https://loremflickr.com/600/600/gym,shirt?lock=13", icon: "shirt" },
    { id: "prod-4", name: "Heavy Duty Battle Ropes", price: 49.99, rating: 5, category: "Equipment", desc: "30-foot professional poly-dacron rope with heat-shrink end grips.", image: "https://loremflickr.com/600/600/rope,gym?lock=14", icon: "rope" },
    { id: "prod-5", name: "Stardust Shaker Bottle", price: 14.99, rating: 4, category: "Accessories", desc: "700ml double-insulated stainless steel shaker with orbital mixer spring.", image: "https://loremflickr.com/600/600/shaker,bottle?lock=15", icon: "bottle" },
    { id: "prod-6", name: "Core Support Lifting Belt", price: 39.99, rating: 5, category: "Equipment", desc: "Double-buckled professional leather powerlifting belt with lumbo-sacral padding.", image: "https://loremflickr.com/600/600/belt,gym?lock=16", icon: "belt" },
    { id: "prod-7", name: "Chalk Power Block", price: 8.99, rating: 4, category: "Accessories", desc: "Pure gym-grade magnesium carbonate block for dry palms and solid lifts.", image: "https://loremflickr.com/600/600/chalk,gym?lock=17", icon: "chalk" },
    { id: "prod-8", name: "Alpha Lift Padded Gloves", price: 19.99, rating: 4, category: "Apparel", desc: "Silicone textured palm support with heavy-duty elasticated wrist wraps.", image: "https://loremflickr.com/600/600/gloves,gym?lock=18", icon: "gloves" }
  ];

  const advisors = [
    { id: "adv-1", name: "Dr. Andrew Huberman", specialty: "Neurobiology & Human Performance", rating: 4.99, reviews: 3410, status: "Online", bio: "Stanford Neurobiology professor specializing in circadian optimization, cold exposure protocols, and dopamine resets for maximum athletic output.", color: "linear-gradient(135deg, #a18cd1, #fbc2eb)", image: "https://loremflickr.com/200/200/face,man?lock=111" },
    { id: "adv-2", name: "Jeff Nippard", specialty: "Science-Based Hypertrophy", rating: 4.96, reviews: 2980, status: "Online", bio: "Biochemist and professional drug-free bodybuilder. Famous for referencing clinical trials to compile the ultimate muscle building systems.", color: "linear-gradient(135deg, #ff9a9e, #fecfef)", image: "https://loremflickr.com/200/200/face,man?lock=112" },
    { id: "adv-3", name: "Jeremy Ethier", specialty: "Kinesiology & Corrective Drills", rating: 4.93, reviews: 1840, status: "Online", bio: "Certified kinesiologist dedicated to fixing structural imbalances, rotator cuff health, and optimizing precise joint mechanics.", color: "linear-gradient(135deg, #f6d365, #fda085)", image: "https://loremflickr.com/200/200/face,man?lock=113" },
    { id: "adv-4", name: "Jeff Cavaliere", specialty: "Physical Therapy & Athletic Strength", rating: 4.89, reviews: 2150, status: "In Session", bio: "Physical therapist and strength coach. Founder of ATHLEAN-X, bringing elite sports medicine wisdom directly to intense gym volume splits.", color: "linear-gradient(135deg, #84fab0, #8fd3f4)", image: "https://loremflickr.com/200/200/face,man?lock=114" },
    { id: "adv-5", name: "Dr. Rhonda Patrick", specialty: "Longevity, Nutrition & Heat Shock", rating: 4.97, reviews: 1420, status: "Busy", bio: "Biomedical researcher specializing in hyperthermic conditioning (sauna), micronutrient density, and genetic longevity biomarkers.", color: "linear-gradient(135deg, #a1c4fd, #c2e9fb)", image: "https://loremflickr.com/200/200/face,woman?lock=115" },
    { id: "adv-6", name: "Arnold Schwarzenegger", specialty: "Golden Era Volume & Mind-Muscle", rating: 4.99, reviews: 6830, status: "Offline", bio: "Seven-time Mr. Olympia. Focuses on mental visualization, training past failure, and high-intensity drop sets from the classic era.", color: "linear-gradient(135deg, #cfd9df, #e2ebf0)", image: "https://loremflickr.com/200/200/face,man?lock=116" },
    { id: "adv-7", name: "Mike Mentzer (Legacy Profile)", specialty: "Heavy Duty High-Intensity Training", rating: 4.95, reviews: 840, status: "Online", bio: "High Intensity Training pioneer. Advocating low volume, extreme mechanical stress, and complete muscle recovery under HIT principles.", color: "linear-gradient(135deg, #fbc2eb, #a6c1ee)", image: "https://loremflickr.com/200/200/face,man?lock=117" },
    { id: "adv-8", name: "Meg Squats", specialty: "Powerlifting & Female Strength", rating: 4.92, reviews: 1180, status: "Online", bio: "Competitive powerlifter and creator of Strong Strong Friends. Dedicated to helping lifters master squats, bench, and deadlifts.", color: "linear-gradient(135deg, #fdcbf1, #e6dee9)", image: "https://loremflickr.com/200/200/face,woman?lock=118" },
    { id: "adv-9", name: "Chris Heria", specialty: "Calisthenics & Bodyweight Progressions", rating: 4.87, reviews: 1540, status: "In Session", bio: "Founder of Thenx. Calisthenics expert focusing on advanced floor maneuvers, human flags, planches, and high bodyweight control.", color: "linear-gradient(135deg, #a18cd1, #fbc2eb)", image: "https://loremflickr.com/200/200/face,man?lock=119" },
    { id: "adv-10", name: "Greg Doucette", specialty: "IFBB Pro & Dietetics Coaching", rating: 4.88, reviews: 1390, status: "Online", bio: "IFBB Pro bodybuilder and exercise physiologist. Famous for cardiovascular tips, calorie density recipes, and strict gym form audits.", color: "linear-gradient(135deg, #fbc2eb, #a6c1ee)", image: "https://loremflickr.com/200/200/face,man?lock=120" }
  ];

  const certifications = [
    { id: "cert-1", name: "Certified Personal Trainer (CPT)", body: "Mastery Zone Academy / NASM aligned", price: 199.99, modules: 5, difficulty: "Intermediate", desc: "Gain essential knowledge in movement biomechanics, core client physiology assessments, and custom periodized training design.", icon: "cpt", image: "https://loremflickr.com/600/400/fitness,training?lock=21" },
    { id: "cert-2", name: "Strength & Conditioning Specialist (CSCS)", body: "Elite Mastery Science Board", price: 299.99, modules: 6, difficulty: "Advanced", desc: "Engineered for training competitive athletes. Highlights reactive speed design, structural periodization, and power metrics.", icon: "cscs", image: "https://loremflickr.com/600/400/workout,gym?lock=22" },
    { id: "cert-3", name: "Certified Fitness Nutritionist (CFN)", body: "Mastery Dietetics Division", price: 149.99, modules: 4, difficulty: "Beginner-Intermediate", desc: "Master macronutrient partitioning, biological metabolism, performance eating protocols, and behavioral dietary coaching.", icon: "cfn", image: "https://loremflickr.com/600/400/diet,food?lock=23" },
    { id: "cert-4", name: "Corrective Exercise Specialist (CES)", body: "Mastery Sports Rehab", price: 249.99, modules: 5, difficulty: "Advanced", desc: "Learn to identify joint imbalances, remediate movement limitations, reduce injury risks, and program injury recovery drills.", icon: "ces", image: "https://loremflickr.com/600/400/yoga,stretch?lock=24" }
  ];
  ...
  return (
    <div className="fitness-container page-enter">
      ...
      <header className="fitness-header">
        {/* Logo Container - click returns to Fitness Page Landing View */}
        ...
        <nav className="fitness-nav-bar">
          {/* Square Home Button - click returns to Fitness Page Landing View */}
      ...
      <div className="fitness-main-layout">
        ...
        <aside className="fitness-sidebar">
          <div className="fitness-sidebar-title">Exercises</div>
        ...
        <main className="fitness-content-area">
          ...
          <div className="fitness-content-wrapper">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (val.trim().length > 0) {
                      setActiveTab("dashboard"); // Typing instantly pulls results directly on Fitness homepage!
                    }
                  }}
              ...
              <>
                <div className="fitness-header-group">
                  <h1 className="fitness-main-heading">
                    Train Your Body, Expand Your Mind
                  </h1>
                  <p className="fitness-sub-heading">
                    Discover a space where fitness, learning, and skill-building come together.
                  </p>
                </div>

                <div
                  className="fitness-visual-card"
                  style={{ backgroundImage: `url(${fitnessIllustration})` }}
                >
                  <div className="fitness-card-decorative-square" />

                  <div className="fitness-card-text-container">
                    <div className="fitness-card-row">
                      <span className="fitness-card-text-standard">Together, we</span>
                      <span className="fitness-card-text-retro">move</span>
                    </div>
                    <div className="fitness-card-row">
                      <span className="fitness-card-text-retro">people</span>
                      <span className="fitness-card-text-standard">to live their</span>
                    </div>
                    <div className="fitness-card-row">
                      <span className="fitness-card-text-standard">healthiest lives.</span>
                    </div>
                  </div>
                </div>
              </>
              ...
              <div className="fitness-search-results-section">
                <div className="search-results-header">
                  <div className="search-results-info">
                    ...
                    <p>We found {getFullSearchResults().length} active features in the Fitness Zone matching your keywords</p>
                  </div>
            ...
            {activeTab === "certification" && (
              <div className="fitness-section-container">
                <div className="fitness-section-header">
                  <h1 className="fitness-section-heading">PROFESSIONAL CERTIFICATIONS</h1>
                  <p className="fitness-section-subheading">Accelerate your career with elite academy-recognized training degrees</p>
                </div>

                <div className="cert-grid">
                  {certifications.map((cert) => {
                    // Merge static catalog data with backend dynamic data
            ...
            {activeTab === "resources" && (
              <div className="fitness-section-container">
                <div className="fitness-section-header">
                  <h1 className="fitness-section-heading">GYM POWER STORE</h1>
                  <p className="fitness-section-subheading">Fuel your workouts and support joint safety with premium gym essentials</p>
                </div>
            ...
            {activeTab === "about" && (
              <div className="fitness-section-container">
                <div className="fitness-section-header">
                  <h1 className="fitness-section-heading">OUR PHILOSOPHY & VISION</h1>
                  <p className="fitness-section-subheading">Merging biomechanical integrity with neural physical peak capacity</p>
                </div>
                ...
                <div className="about-interactive-box">
                  <p className="about-intro-text">
                    At **Fitness Zone**, we don't believe in generic protocols. We develop programs that fuse neuromuscular alignment, hypertrophy principles, and cardiovascular efficiency.
                  </p>
            ...
            {activeTab === "advisor" && (
              <div className="fitness-section-container">
                <div className="fitness-section-header">
                  <h1 className="fitness-section-heading">WORLD CLASS ATHLETIC ADVISORS</h1>
                  <p className="fitness-section-subheading">Consult with top science-based researchers, IFBB pros, and biomechanics gurus</p>
                </div>
            ...
            {activeTab === "help" && (
              <div className="fitness-section-container">
                <div className="fitness-section-header">
                  <h1 className="fitness-section-heading">ATHLETIC HELPDESK</h1>
                  <p className="fitness-section-subheading">Expand your anatomical knowledge, test your lift metrics, and contact safety advisors</p>
                </div>
            ...
            {activeTab === "cart" && (
              <div className="fitness-section-container">
                <div className="fitness-section-header">
                  <h1 className="fitness-section-heading">YOUR POWER CART</h1>
                  <p className="fitness-section-subheading">Review your products and proceed with MasteryPay secure checkout</p>
                </div>
            ...
            {activeTab === "members" && (
              <div className="fitness-section-container">
                <div className="fitness-section-header">
                  <h1 className="fitness-section-heading">GYM MEMBER PORTAL</h1>
                  <p className="fitness-section-subheading">Configure your premium plan, build your family fitness roster, and customize your glassmorphic pass</p>
                </div>
                      ...
                      <div className="pass-customizer-controls">
                        ...
                        <div className="form-group">
                          ...
                          >
                            ...
                            <option value="guru">🧘 Fitness Guru</option>
                          </select>
                        </div>
                      </div>
                        ...
                        <div className="success-roster-list">
                          ...
                          {rosterList.map((m) => (
                            <div key={m.id} className="success-roster-item">
                              ...
                              <div className="success-roster-sub">Fitness Goal: {m.goal}</div>
                            </div>
                          ))}
                        </div>
      ...
      {isModalOpen && (
        <div className="fitness-modal-overlay" onClick={() => setIsModalOpen(false)}>
          ...
          >
            ...
            <h2 className="fitness-modal-title">EXERCISE TUTORIAL ZONE</h2>
            ...
            <div className="fitness-modal-exercise-grid">
              {exercises.map((category) => (
                <button
                  key={category}
                  className={`fitness-modal-exercise-pill ${modalSelectedExercise === category ? "active" : ""}`}
