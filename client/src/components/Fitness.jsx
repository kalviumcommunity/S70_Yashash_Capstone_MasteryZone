...
const Fitness = () => {
  ...
  const certifications = [
    ...
    { id: "cert-4", name: "Corrective Exercise Specialist (CES)", body: "Mastery Sports Rehab", price: 249.99, modules: 5, difficulty: "Advanced", desc: "Learn to identify joint imbalances, remediate movement limitations, reduce injury risks, and program injury recovery drills.", icon: "ces", image: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?auto=format&fit=crop&w=600&q=80" }
  ];
