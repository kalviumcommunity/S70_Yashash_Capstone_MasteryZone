...
const Coding = () => {
  ...
  const products = [
    { id: "prod-1", name: "Mastery RGB Mechanical Keyboard", price: 129.99, rating: 5, category: "Hardware", desc: "Hot-swappable tactile linear switches with premium glowing cyber-purple backlit keycaps.", image: "https://loremflickr.com/600/600/keyboard,rgb?lock=31" },
    { id: "prod-2", name: "Alpha Comfort Vertical Mouse", price: 49.99, rating: 5, category: "Hardware", desc: "Ergonomic vertical shape engineered to reduce forearm wrist tension during intense coding sessions.", image: "https://loremflickr.com/600/600/mouse,computer?lock=32" },
    { id: "prod-3", name: "Curved 34-Inch Coding Monitor", price: 449.99, rating: 5, category: "Hardware", desc: "Ultra-wide QHD panoramic 144Hz monitor for managing multiple split-screen editor panes cleanly.", image: "https://loremflickr.com/600/600/monitor,screen?lock=33" },
    { id: "prod-4", name: "Insulated Smart Temp Coffee Mug", price: 34.99, rating: 4, category: "Accessories", desc: "Temperature-controlled leakproof smart cup that keeps developer drinks hot for up to 8 hours.", image: "https://loremflickr.com/600/600/mug,coffee?lock=34" },
    { id: "prod-5", name: "Premium Blue-Light Blocking Glasses", price: 19.99, rating: 4, category: "Apparel", desc: "Antiglare lenses designed to shield developer eyes from blue screens and decrease eye strain.", image: "https://loremflickr.com/600/600/glasses,nerd?lock=35" },
    { id: "prod-6", name: "Active Noise-Canceling Headphones", price: 179.99, rating: 5, category: "Hardware", desc: "Over-ear noise isolation headphones to block surrounding ambient noise and lock in focus.", image: "https://loremflickr.com/600/600/headphones,audio?lock=36" },
    { id: "prod-7", name: "Mastery Memory-Foam Wrist Rest", price: 14.99, rating: 4, category: "Accessories", desc: "Premium memory foam keyboard padding to support wrist bones during rapid coding streaks.", image: "https://loremflickr.com/600/600/keyboard,desk?lock=37" },
    { id: "prod-8", name: "Mastery Zone Code Hoodie (Purple)", price: 39.99, rating: 5, category: "Apparel", desc: "Ultra-soft cotton programming hoodie styled with custom neon compiler print logos.", image: "https://loremflickr.com/600/600/hoodie,clothes?lock=38" }
  ];

  const advisors = [
    { id: "adv-1", name: "Linus Torvalds", specialty: "OS Kernels & Git Systems", rating: 4.99, reviews: 9410, status: "Online", bio: "Creator of Linux and Git. Consult on low-level memory allocation, core architecture, and decentralization systems.", color: "linear-gradient(135deg, #a18cd1, #fbc2eb)", image: "https://loremflickr.com/200/200/face,man?lock=41" },
    { id: "adv-2", name: "Dan Abramov", specialty: "React Core & State Engines", rating: 4.97, reviews: 4980, status: "Online", bio: "Co-creator of Redux and React core alumni. Expert in virtual DOM reconciliations, custom hooks, and concurrent render loops.", color: "linear-gradient(135deg, #ff9a9e, #fecfef)", image: "https://loremflickr.com/200/200/face,man?lock=42" },
    { id: "adv-3", name: "Brendan Eich", specialty: "JavaScript Engines & Browsers", rating: 4.96, reviews: 3840, status: "Online", bio: "Creator of JavaScript and co-founder of Mozilla. Consult on compilation strategies, V8 optimization, and WebAssembly.", color: "linear-gradient(135deg, #f6d365, #fda085)", image: "https://loremflickr.com/200/200/face,man?lock=43" },
    { id: "adv-4", name: "Guido van Rossum", specialty: "Python Algorithms & Clean Code", rating: 4.92, reviews: 3150, status: "In Session", bio: "Creator of Python. Expert in scripting automation, language design paradigms, list comprehensions, and PEP-8 clean code.", color: "linear-gradient(135deg, #84fab0, #8fd3f4)", image: "https://loremflickr.com/200/200/face,man?lock=44" },
    { id: "adv-5", name: "Bjarne Stroustrup", specialty: "C++ Compilation & Memory management", rating: 4.95, reviews: 2420, status: "Busy", bio: "Creator of C++. Specialized in manual pointer handling, dynamic memory allocations, structures, and low-latency threading.", color: "linear-gradient(135deg, #a1c4fd, #c2e9fb)", image: "https://loremflickr.com/200/200/face,man?lock=45" },
    { id: "adv-6", name: "Lex Fridman", specialty: "Artificial Intelligence & Neural Networks", rating: 4.91, reviews: 6830, status: "Offline", bio: "MIT AI researcher. Consult on PyTorch modeling, deep reinforcement learning, neural node weights, and autonomous systems.", color: "linear-gradient(135deg, #cfd9df, #e2ebf0)", image: "https://loremflickr.com/200/200/face,man?lock=46" },
    { id: "adv-7", name: "Sir Tim Berners-Lee", specialty: "HTTP Protocols & Web Architectures", rating: 4.99, reviews: 1840, status: "Online", bio: "Inventor of the World Wide Web. Specialized in semantic web data models, protocol handshakes, and global decentralized networks.", color: "linear-gradient(135deg, #fbc2eb, #a6c1ee)", image: "https://loremflickr.com/200/200/face,man?lock=47" },
    { id: "adv-8", name: "James Gosling", specialty: "Java JVM & Multithreading", rating: 4.88, reviews: 2180, status: "Online", bio: "Creator of Java. Expert in JVM byte-code compilations, garbage collectors, cross-platform stability, and robust OOP abstractions.", color: "linear-gradient(135deg, #fdcbf1, #e6dee9)", image: "https://loremflickr.com/200/200/face,man?lock=48" },
    { id: "adv-9", name: "Dr. Andrew Ng", specialty: "Machine Learning & Models Training", rating: 4.98, reviews: 5540, status: "In Session", bio: "Google Brain co-founder. Specialized in custom gradient descent algorithms, neural layers tuning, and commercial scale AI models.", color: "linear-gradient(135deg, #a18cd1, #fbc2eb)", image: "https://loremflickr.com/200/200/face,man?lock=49" },
    { id: "adv-10", name: "Dr. Grace Hopper (Legacy Profile)", specialty: "Compilers & Flow-Matic Logic", rating: 4.99, reviews: 8840, status: "Online", bio: "Compiler design pioneer. Specialized in translating structural syntax trees, static analysis, machine codes, and early bug tracking.", color: "linear-gradient(135deg, #fbc2eb, #a6c1ee)", image: "https://loremflickr.com/200/200/face,woman?lock=50" }
  ];

  const certifications = [
    { id: "cert-1", name: "Full-Stack Developer (FSD)", body: "Mastery Zone Academy / W3C aligned", price: 199.99, modules: 5, difficulty: "Intermediate", desc: "Master full stack paradigms: front-end styling structures, interactive Javascript layers, SQL databases, and API gateways.", icon: "fsd", image: "https://loremflickr.com/600/400/computer,code?lock=51" },
    { id: "cert-2", name: "Cloud Architect Specialist (CAS)", body: "Elite Cloud Solutions Board", price: 299.99, modules: 6, difficulty: "Advanced", desc: "Design high-availability cloud setups. Highlight serverless operations, database load scaling, and secure network layers.", icon: "cas", image: "https://loremflickr.com/600/400/server,cloud?lock=52" },
    { id: "cert-3", name: "AI & Machine Learning Engineer (AIML)", body: "Mastery Advanced AI Division", price: 249.99, modules: 5, difficulty: "Advanced", desc: "Build predictive algorithmic weights. Master linear regression gradients, deep neural layers, and custom CNN classification.", icon: "aiml", image: "https://loremflickr.com/600/400/network,ai?lock=53" },
    { id: "cert-4", name: "Cybersecurity Professional (CSP)", body: "Mastery Defensive Sec Board", price: 149.99, modules: 4, difficulty: "Beginner-Intermediate", desc: "Identify architectural vulnerabilities, remediate injection injection risks, analyze port packages, and build solid cyber defenses.", icon: "csp", image: "https://loremflickr.com/600/400/security,hacker?lock=54" }
  ];
            ...
            {activeTab === "members" && (
              <div className="fitness-section-container">
                <div className="fitness-section-header">
                  ...
                  <p className="fitness-section-subheading">Configure your development team plan, build your developer roster, and customize your glassmorphic pass</p>
                </div>
                ...
                {!membershipSuccess ? (
                  <div className="membership-layout">
                    ...
                    <div className="membership-left-panel">
                        ...
                        <div className="pricing-grid">
                          ...
                          <div className={`pricing-card ${membershipForm.tier === "silver" ? "selected" : ""}`} onClick={() => setMembershipForm({ ...membershipForm, tier: "silver" })}>
                            ...
                            <ul className="tier-features">
                              ...
                              <li>✔ Standard compiler workspaces</li>
                              <li>✔ Community help forums</li>
                              <li>✖ Team pipelines & CI/CD</li>
                          ...
                          <div className={`pricing-card ${membershipForm.tier === "gold" ? "selected" : ""}`} onClick={() => setMembershipForm({ ...membershipForm, tier: "gold" })}>
                            ...
                            <ul className="tier-features">
                              ...
                              <li>✔ Standard compiler workspaces</li>
                              <li>✔ Full Team pipelines & CI/CD</li>
                              <li>✔ Basic cloud hostings</li>
                              <li>✖ VIP Lounge & advisors</li>
                            </ul>
                          </div>
                          ...
                          <div className={`pricing-card platinum ${membershipForm.tier === "platinum" ? "selected" : ""}`} onClick={() => setMembershipForm({ ...membershipForm, tier: "platinum" })}>
                            ...
                            <ul className="tier-features">
                              ...
                              <li>✔ Full Team pipelines & CI/CD</li>
                              <li>✔ 1-on-1 advisor consultations</li>
                              <li>✔ Dedicated enterprise cloud server</li>
                      ...
                      <form onSubmit={handleMembershipSubmit} className="roster-form-box">
                        <h3>2. Primary Developer Details</h3>
                        <div className="form-row-2">
                          <div className="form-group">
                        ...
                        <div className="roster-builder-section">
                          <h3>3. Configure Team Developers Roster</h3>
                          <p className="roster-lead-info">Add additional developers to code as a team! Each added seat receives heavy discount rates at just <strong>$14.99/mo</strong>.</p>
                          ...
                          <div className="roster-adder-form">
                            ...
                            >
                              ...
                              <option value="Build APIs">Build APIs</option>
                              <option value="Deploy Pods">Deploy Pods</option>
                        ...
                        <div className="roster-checkout-summary">
                          ...
                          <div className="roster-financials">
                            ...
                            <div className="financial-row">
                              <span>Additional Developer Seats Added ({rosterList.length})</span>
                          ...
                          <button type="submit" className="place-order-btn" style={{ marginTop: "20px" }} disabled={isMembershipProcessing}>
                            {isMembershipProcessing ? "Processing Team Signups..." : `Authorize Roster Seats ($${getMembershipTotals().total}/mo)`}
                          </button>
                        </div>
                      </form>
                    </div>
                    ...
                    <div className="membership-right-panel pass-preview-container">
                      <div className="pass-customizer-controls">
                        ...
                        <p className="customizer-lead">Customize highlights, colors, and layout icons of your active developer pass in real-time!</p>
                        ...
                        <div className="form-group">
                          ...
                          <select
                            ...
                            className="checkout-input"
                          >
                            <option value="athlete">🏋️ Elite Coder</option>
                            <option value="beast">🦁 Cyber Beast</option>
                            <option value="ninja">🥷 Git Ninja</option>
                            <option value="guru">🧘 Code Guru</option>
                          </select>
                        </div>
                      </div>
                      ...
                      <div className="digital-pass-card" style={{ borderColor: membershipForm.accentColor, boxShadow: `0 8px 30px rgba(0,0,0,0.7), 0 0 25px ${membershipForm.accentColor}33` }}>
                        ...
                        <div className="pass-header">
                          <div className="pass-title">CODING ZONE</div>
                  ...
                  <div className="checkout-success-container" style={{ animation: "fadeIn 0.5s ease-out", maxWidth: "850px", margin: "0 auto" }}>
                    ...
                    <p className="success-order-msg">Welcome to the Elite Mastery Coding Space! Your developer roster has been secured under Contract ID: <strong>MZ-CTR-DEV-{Math.floor(100000 + Math.random() * 900000)}</strong></p>

                    <div className="roster-success-grid">
                      {/* Left: Active Roster Summary */}
                      <div className="success-receipt-card" style={{ textAlign: "left" }}>
                        <h4>📋 Activated Developer Roster</h4>
                        <div className="success-roster-list">
                          <div className="success-roster-item primary">
                            <strong>{membershipForm.primaryName}</strong> (Primary Developer)
                          ...
                          {rosterList.map((m) => (
                            <div key={m.id} className="success-roster-item">
                              ...
                              <div className="success-roster-sub">Goal: {m.goal}</div>
                            </div>
                          ))}
                        </div>
